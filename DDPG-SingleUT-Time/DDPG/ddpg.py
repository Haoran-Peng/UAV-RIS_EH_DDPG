...
class DDPGagent:
    def __init__(self, env, hidden_size=[64, 64], actor_learning_rate=1e-5, critic_learning_rate=1e-4, gamma=0.99, tau=5e-3, max_memory_size = 100000000):
        ...
        self.actor_target = Actor(self.num_states, self.num_actions, hidden_size).to(self.device)
        self.critic = Critic(self.num_states + self.num_actions, self.num_actions, hidden_size).to(self.device)
        self.critic_target = Critic(self.num_states + self.num_actions, self.num_actions, hidden_size).to(self.device)
