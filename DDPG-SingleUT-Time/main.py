...
agent = DDPGagent(env, hidden_size=[64, 64], actor_learning_rate=1e-5, critic_learning_rate=1e-4, max_memory_size = pow(2, 28))
    ...
    for episode in range(14000):
        ...
        for step in range(81):
            if step+(81*episode) < start_steps:
                ...
                action = noise.get_action(action) # exploration
